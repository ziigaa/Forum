...
public class Database {
    ...
    private List<String> sqliteLauseet() {
        ...
        lista.add("CREATE TABLE Topics (topic_id INTEGER PRIMARY KEY NOT NULL, subject text NOT NULL, time date NOT NULL, category INTEGER NOT NULL, user INTEGER NOT NULL, FOREIGN KEY (category) REFERENCES Categories(cat_id), FOREIGN KEY (user) REFERENCES Users(user_id));");
        lista.add("CREATE TABLE Posts(post_id INTEGER PRIMARY KEY NOT NULL, message text NOT NULL, time date NOT NULL, topic INTEGER NOT NULL, user INTEGER NOT NULL, FOREIGN KEY (topic) REFERENCES Topics(topic_id), FOREIGN KEY (user) REFERENCES Users(user_id));");
